...
KERNEL_STATE_VARS = (
    ...
    "STDP3", "STDP3C", "STDP_SURPRISE_GATE", "STDP_TWO_TIMESCALE", "STDP_TARGET", "RESERVOIR", "RESERVOIR_SIZE", "RESERVOIR_SPARSITY", "RESERVOIR_EI_RATIO", "RESERVOIR_TAU", "MULTISCALE",
    ...
    "FREE_ENERGY", "NO_DEATH", "SUPERVISED_TEACHER",
)
...
def _mirror_values_from_env():
    ...
    values = {
        ...
        "RESERVOIR": flag("GENESIS_RESERVOIR", "0"),
        "RESERVOIR_SIZE": i("GENESIS_RESERVOIR_SIZE", "256"),
        "RESERVOIR_SPARSITY": f32("GENESIS_RESERVOIR_SPARSITY", "0.1"),
        "RESERVOIR_EI_RATIO": f32("GENESIS_RESERVOIR_EI_RATIO", "0.8"),
        "RESERVOIR_TAU": f32("GENESIS_RESERVOIR_TAU", "20.0"),
...
ENV_NAME_MAP = {
    ...
    "GENESIS_RESERVOIR": "RESERVOIR",
    "GENESIS_RESERVOIR_SIZE": "RESERVOIR_SIZE",
    "GENESIS_RESERVOIR_SPARSITY": "RESERVOIR_SPARSITY",
    "GENESIS_RESERVOIR_EI_RATIO": "RESERVOIR_EI_RATIO",
    "GENESIS_RESERVOIR_TAU": "RESERVOIR_TAU",
