...
# ---- Session 13: competitive racing reward (feature-flagged, default OFF) ----
INCOME_RACE = os.environ.get("GENESIS_INCOME_RACE", "0") == "1"
RACE_N_QUESTIONS = max(1, int(os.environ.get("GENESIS_RACE_N_QUESTIONS", "8")))
RACE_STRIDE = max(1, int(os.environ.get("GENESIS_RACE_STRIDE", "256")))
RACE_K = max(1, int(os.environ.get("GENESIS_RACE_K", str(LUMPSUM_K))))

# Module-level race state arrays (passed to @njit as args)
