"""
Experiment 83: Depth-Differentiated Grounded Income Driver (Rule 3, Rule 8, Rule 18, Rule 20)
=============================================================================================
...
ARMS = [
    {"name": "Arm 1: Control (Flat Income)", "env": {"GENESIS_DEPTH_INCOME": "0"}},
    {"name": "Arm 2: Proposed (Depth Income)", "env": {"GENESIS_DEPTH_INCOME": "1"}},
]
...
def main():
    worker_script = os.path.join(REPO_ROOT, "exp83_worker.py")
    with open(worker_script, "w", encoding="utf-8") as f:
        f.write(SUBWORKER_CODE)

    print("==========================================================================")
    print("Experiment 83: Depth-Differentiated Income Multi-Seed Driver (Rule 3)")
    print("==========================================================================")
    ...
    arm1_pop = arm_stats["Arm 1: Control (Flat Income)"]["mean_pop"]
    arm2_pop = arm_stats["Arm 2: Proposed (Depth Income)"]["mean_pop"]
    arm2_std = arm_stats["Arm 2: Proposed (Depth Income)"]["std_pop"]
    ...
    out_file = os.path.join(REPO_ROOT, "exp83_results.json")
    summary = {
        "arms": results,
        "stats": arm_stats,
        "delta_pop": delta_pop,
