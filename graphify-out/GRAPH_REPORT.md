...
## Corpus Check
- 6 files · ~198,069 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1663 nodes · 2242 edges · 176 communities (92 shown, 84 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 22 edges (avg confidence: 0.71)
...
1. `TestTailwindConfigGenerator` - 35 edges
2. `TestTailwindConfigGenerator` - 35 edges
3. `TestShadcnInstaller` - 26 edges
4. `TestShadcnInstaller` - 26 edges
5. `TailwindConfigGenerator` - 25 edges
6. `TailwindConfigGenerator` - 21 edges
7. `color` - 15 edges
8. `color` - 15 edges
9. `validate()` - 14 edges
...
- `TestShadcnInstaller` --uses--> `ShadcnInstaller`  [INFERRED]
  .agents/skills/ui-styling/scripts/tests/test_shadcn_add.py → .claude/skills/ui-styling/scripts/shadcn_add.py
- `TestTailwindConfigGenerator` --uses--> `TailwindConfigGenerator`  [INFERRED]
  .agents/skills/ui-styling/scripts/tests/test_tailwind_config_gen.py → .claude/skills/ui-styling/scripts/tailwind_config_gen.py
- `TestGeneratedConfigIsValidJs` --uses--> `TailwindConfigGenerator`  [INFERRED]
  .agents/skills/ui-styling/scripts/tests/test_tailwind_config_gen.py → .claude/skills/ui-styling/scripts/tailwind_config_gen.py
- `Graph Physics Engine (genesis_engine.py / DynamicBrain, deleted)` --semantically_similar_to--> `Life by Reading (Book Economy)`  [INFERRED] [semantically similar]
  Docs/Roadmap.md → Docs/Result.md
- `Lamarckian Consolidation` --semantically_similar_to--> `Fossil Pool with Horizontal Gene Transfer`  [INFERRED] [semantically similar]
  Docs/ARD.md → Docs/Article_Draft.md

## Import Cycles
- None detected.

## Communities (176 total, 84 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.05
Nodes (69): get_context(), is_allowed_exception(), is_allowed_rgba(), is_inside_block(), load_css_variables(), main(), print_result(), print_summary() (+61 more)

### Community 1 - "Community 1"
Cohesion: 0.05
Nodes (59): 20 W Brain Paradigm / Prime Directive (Rule 6), Autotelic Imperative (Rule 9), Baldwin-style Lifetime Learning, books_of_genesis.py, Computational Viscosity (Rule 13), Architecture-Derived Compute Latency, Cosmic Radiation (Entropy), CYCLES_PER_EAT_GAIN (meal value) (+51 more)
...
Cohesion: 0.05
Nodes (22): Tests for shadcn_add.py, Test adding components without shadcn config., Test adding components that are already installed., Test adding components with overwrite flag., Test adding components in dry run mode., Test successful component addition., Test ShadcnInstaller class., Test component addition with subprocess error. (+14 more)
...
Cohesion: 0.07
Nodes (33): ansi_ljust(), DesignSystemGenerator, _detect_page_type(), format_ascii_box(), format_markdown(), format_master_md(), format_page_override_md(), generate_design_system() (+25 more)
...
Cohesion: 0.09
Nodes (31): BM25, calculate_pattern_break(), detect_domain(), get_background_config(), get_color_for_emotion(), get_layout_for_goal(), get_typography_for_slide(), _load_csv() (+23 more)
...
Cohesion: 0.14
Nodes (24): broadcast_msg(), create_intelligent_ancestor(), crossover_dna(), find_birth_pos(), get_base_physics_header(), mutate_dna(), Horizontal gene transfer: keep parent A's protected physics header (bytes 0-9) a, Preserve an elite genome as a dead-DNA fossil for later recombination (HGT). (+16 more)
...
Cohesion: 0.15
Nodes (7): Test TailwindConfigGenerator class., Test plugin recommendations for Next.js., Test writing configuration to file., Test default output path for JavaScript., Test custom output path., Test adding custom colors., TestTailwindConfigGenerator

### Community 41 - "Community 41"
Cohesion: 0.18
Nodes (6): Test adding custom fonts., Test TailwindConfigGenerator class., Test writing config to invalid path., Test default output path for JavaScript., Test default content paths for React., TestTailwindConfigGenerator
...
Cohesion: 0.24
Nodes (10): get_library_books(), inject_curriculum_file(), inject_custom_book(), inject_passage(), Injects a custom string (or chunk of a book) into RAM as one contiguous passage., Inject a whole book file as ONE contiguous passage (a "page"). `at` pins the sta, Returns a structured list of available curriculum files in the Books/ directory., Restock the library IN PLACE: grow the next passage adjacent to text that alread (+2 more)
...
Cohesion: 0.25
Nodes (5): Tests for shadcn_add.py, Test adding components with overwrite flag., Test ShadcnInstaller class., Test component addition with subprocess error., TestShadcnInstaller

### Community 58 - "Community 58"
Cohesion: 0.39
Nodes (7): drain_reads(), encounter_frac(), lib_bytes(), main(), Throwaway M1 economy probe: WHY does the books economy collapse? Measure, don't, Books-honest spawn: place organisms on empty cells whose scan window already con, seed_in_library()
...
Cohesion: 0.47
Nodes (5): format_context(), format_result(), main(), Format a single search result for display, Format contextual recommendations for display.
...
Cohesion: 0.47
Nodes (5): _elite_synapses(), _mean_synapses_alive(), Tierra-Trap verification (Gemini thermodynamic-fix audit, 2026-07-11).  CLAIM un, Synapse count of the oldest living organism = what the Ark preserves/reseeds., run()
...
## Knowledge Gaps
- **212 isolated node(s):** `canvas`, `ctx`, `btnAnalyze`, `btnFullscreen`, `mainViz` (+207 more)
...
- **Why does `TestShadcnInstaller` connect `Community 57` to `Community 128`, `Community 129`, `Community 130`, `Community 131`, `Community 132`, `Community 133`, `Community 134`, `Community 135`, `Community 136`, `Community 137`, `Community 138`, `Community 139`, `Community 140`, `Community 141`, `Community 142`, `Community 30`, `Community 122`, `Community 123`, `Community 124`, `Community 125`, `Community 126`, `Community 127`?**
