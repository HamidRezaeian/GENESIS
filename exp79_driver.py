...
print(f"Spawn: alive={g_alive[0]}, E={g_energy[0]:.0f}, n={g_org_n_count[0]}, s={g_org_s_count[0]}, depth={g_org_lif_steps[0]}", flush=True)
...
for tick in range(N_TICKS):
    ...
    if (tick+1) % 1000 == 0:
        ...
        reads = int(g_read_log[:MAX_ORGANISMS].sum())
