...
# Spawn with DEFAULT energy (250000)
...
# Check spawn
print(f"After spawn: alive={g_alive[0]}, energy={g_energy[0]:.0f}, pos={g_positions[0]}", flush=True)
print(f"  n_count={g_org_n_count[0]}, s_count={g_org_s_count[0]}, lif_steps={g_org_lif_steps[0]}", flush=True)
...
spawn_organism(0, 100, ancestor, 250000)
g_read_log[0] = 0
print(f"Re-spawn: alive={g_alive[0]}, E={g_energy[0]:.0f}", flush=True)
